            ...
            <List>
              {districts.map((district, index) => (
                <ListItem
                  key={index}
                  sx={{
                    borderBottom: index < districts.length - 1 ? '1px solid rgba(255,255,255,0.1)' : 'none',
                    py: 2
                  }}
                >
                  ...
                  <Box sx={{ minWidth: 200 }}>
                    <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
                      ...
                      <Typography variant="body2">{district.securityLevel}%</Typography>
                    </Box>
                    <ProgressBar
                      variant="determinate"
            ...
            <List>
              {systems.map((system, index) => (
                <ListItem
                  key={index}
                  sx={{
                    borderBottom: index < systems.length - 1 ? '1px solid rgba(255,255,255,0.1)' : 'none',
                    py: 2
                  }}
                >
                  <ListItemIcon sx={{ color: 'inherit' }}>
                  ...
                  <Box sx={{ minWidth: 100 }}>
                    <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
                      <Typography variant="body2">{system.coverage}%</Typography>
                    </Box>
                    <ProgressBar
                      variant="determinate"
